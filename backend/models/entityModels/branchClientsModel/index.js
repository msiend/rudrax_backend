...
class BranchClientsModel {
  constructor(b_client_id, b_r_id, b_client_name, b_client_ref_no, b_client_contact, b_client_alt_contact, b_client_address, b_client_email, b_client_housetype, b_client_rcctype, b_client_totalcost, b_client_advancepayment, b_client_sitedesc, b_client_duration, b_client_commision, b_admin_approval) {
  ...
  static async create(data) {
    const query = `INSERT INTO branch_clients (b_r_id, b_client_name, b_client_ref_no, b_client_contact, b_client_alt_contact, b_client_address, b_client_email, b_client_housetype, b_client_rcctype, b_client_totalcost, b_client_advancepayment, b_client_sitedesc, b_client_duration, b_client_commision, b_admin_approval) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)`;
    const connPool = await pool.getConnection();
    try {
