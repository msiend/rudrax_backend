...
const ProjectSubphaseController = {
  ...
  async findOne(req, res) {
    try {
      const data = await ProjectSubphaseModel.findOne(req.params.id);
  ...
  async update(req, res) {
    try {
      const success = await ProjectSubphaseModel.update(req.params.id, req.body);
  ...
  async delete(req, res) {
    try {
      const success = await ProjectSubphaseModel.delete(req.params.id);
