...
class SiteInspectionsController {
   ...
   static async create(req, res) {
      try {
         const { pro_id, si_asign_id,si_asign_by, si_date, si_location, si_type,si_feedback, status } = req.body;
         const result = await SiteInspectionModel.create(pro_id, si_asign_id,si_asign_by, si_date, si_location, si_type,si_feedback, status);
         if (!result.status) {
         ...
         res.status(201).send({
            ...
            data: { si_id: result.id, pro_id, si_asign_id,si_asign_by, si_date, si_location, si_type,si_feedback, status},
         });
      } catch (error) {
         console.error(error);
         res.status(500).send({
   ...
   static async update(req, res) {
      try {
         const { si_id, pro_id, si_asign_id,si_asign_by, si_date, si_location, si_type,si_feedback, status} = req.body;

         const result = await SiteInspectionModel.update(si_id,pro_id, si_asign_id,si_asign_by, si_date, si_location, si_type,si_feedback, status);
         ...
         res.status(200).send({
            ...
            data: {si_id,pro_id, si_asign_id,si_asign_by, si_date, si_location, si_type,si_feedback, status},
         });
      } catch (error) {
         console.error(error);
         res.status(500).send({
